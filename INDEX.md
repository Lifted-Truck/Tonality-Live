...
- [L0006] Conform results come back onset-sorted (docstring says otherwise) — pair before/after via `report.edits`, never by position — `bridge-contract`, `tonality-integration` (candidate)
